...
func runConcurrent(block: dispatch_block_t!) {
  runConcurrent(after: 0, block: block)
}
...
func runConcurrent(after after: Double, block: dispatch_block_t!) {
  runQueue(after: after, queue: dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), block: block)
}
